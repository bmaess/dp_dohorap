...
According to the Wiener principle [1.4.information], information processing in general consists of three separate tasks: information storage, information modification and information transfer.
...
Historically, information transfer has been explored by calculating functional connectivity.
...
The commonly used model-based approaches are statistic equation modelling [Raatikainen 35] and dynamic causal modelling [Raatikainen 13].
...
This data-driven approach was incepted with Granger causality, which is built on Wiener's assumption that causes precede their effects in time.
...
Importantly, all following methods are robust against a common effect in realistic electrophysical data: volume conduction [Raatikainen 44].
...
All of these issues are resolved with the generalized PDC (gPDC).
...
Next to mutual information and joint entropy, transfer entropy (TE) is by far the most advanced information-theoretic approach [Raatikainen 14].
TE is a non-linear, model-free approach, is resistant to indirect causal effects and volume conduction, and incorporates both dynamical and directional information [Raatikainen 15].
...
The most popular implementation of TE, TrenTOOL, allows for computing group-level statistics and impacts of conditional effects, making it the ideal software for the goal of my study.