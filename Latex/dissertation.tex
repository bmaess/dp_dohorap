...
\onehalfspacing % bzw. \doublespacing, \singlespacing, \onehalfspacing
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Wenn du möchtest, dass Vorspann, Hauptteil und Nachspann deines Dokuments seperat    %
% nummeriert werden, dann trenne diese Teile mittels \frontmatter, \mainmatter und     %
% \backmatter. Alles zwischen den ersten beiden bekommt (standardmässig) römische      %
% Ziffern, nach \mainmatter wird alphanumerisch gezählt (von Eins an), und \backmatter %
% zählt (standardmässig) weiter, das lässt sich aber konfigurieren                     %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
