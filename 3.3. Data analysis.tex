...
Data preprocessing  three software packages: Elekta Neuromag\textsuperscript{\textregistered} MaxFilter (version 2.2, \cite{3.3.MNE}), Matlab (version 2014a) and MNE-Python (version 0.8.6, \cite{3.3.MNEpython}).
...
The condition effect was used to determine relevant time intervals.
Selecting data purely based on the contrast between experimental conditions will include spurious differences as well as the condition-based differences in activity.
Since the subsequent statistical analysis compares the same contrast, it is prone to overestimate the condition effect.
