...
for subjectID = 1:21
    ...
    responseList = {};
    wordlist = {};
    for i = 1:3 % iterate over words in sentence
        m = 0;
        wordlist = {};
        ...
        for n = 1:size(wordlist,2)
            words{subjectID,i,n} = wordlist{n};
        end;
    end;
    ...
    for n = 1:size(logfile,2)
        ...
        if stimulusActive == 1
            ...
            if strcmp(logfile(n).event_type, 'Response')
                ...
                for wordtype = 1:3
                    fitword = 0;
                    for word = 1:size(words,3)
                        if strcmp(sentence{wordtype}, words{subjectID, wordtype, word}) == 1
                            fitword = word;
                        end;
                    end;
