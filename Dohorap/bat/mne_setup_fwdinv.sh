...
usage : mne_setup_fwdinv.sh measfile mrifile bemfile srcfile [covfile]
...
export FSLSUBJECT=`perl -e 'printf "%s",substr($ARGV[0],0,4)' $TMP1`
...
make -rf ${MAKEPATH}/mne_setup_fwdinv_Makefile
